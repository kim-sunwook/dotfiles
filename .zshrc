...
alias iff="cursor ~/code/det-items-factory-frontend"
alias ifb="cursor ~/code/det-items-factory-backend"
alias examadmin="cursor ~/code/det-exam-administration-backend"
alias itemsb="cursor ~/code/det-items-backend"
alias detweb="cursor ~/code/det-web"
